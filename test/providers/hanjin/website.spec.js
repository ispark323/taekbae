...
const
  ...
  Hanjin        = require('../../../src/providers/hanjin/website');

describe('providers/hanjin/website module', () => {
...
describe('providers/hanjin/website class', () => {
  ...
  describe('#source', () => {
    ...
    it('should set `source` property as `website`', () => {
      expect(hanjin.source).equal('website');
    });
  });
  ...
  describe('#parse', () => {
    ...
    it('should parse html using test fixture', (done) => {
      fs.readFile(path.join(__dirname, '../../fixtures/hanjin/website/empty.fixture.html'), (e, data) => {
        if (e) { return done(e); }
        ...
        hanjin.parse(data, (e, data) => {
          ...
          fs.readFile(path.join(__dirname, '../../fixtures/hanjin/website/wrong-status.fixture.html'), (e, data) => {
            if (e) { return done(e); }
            ...
            hanjin.parse(data, (e) => {
              ...
              fs.readFile(path.join(__dirname, '../../fixtures/hanjin/website/in-delivery.fixture.html'), (e, data) => {
                if (e) { return done(e); }
                ...
                hanjin.parse(data, (e, data) => {
                  ...
                  expect(data.status).equal('배송터미널 도착');
                  expect(data.sentAt).instanceOf(Date);
                  expect(data.receivedAt).instanceOf(Date);
                  expect(data.histories).instanceOf(Array);

                  fs.readFile(path.join(__dirname, '../../fixtures/hanjin/website/results.fixture.html'), (e, data) => {
                    if (e) { return done(e); }
                    ...
                    hanjin.parse(data, (e, data) => {
                      ...
                      expect(data.sender).equal('e**********************************');
                      expect(data.recipient).equal('M**********');
                      expect(data.sentAt).instanceOf(Date);
                      expect(data.receivedAt).instanceOf(Date);
                      expect(data.histories).instanceOf(Array);
                      done();
